...
botaoAdicionar.addEventListener('click', function(e) {
  // Está recebendo a função e dizendo a ela para não enviar o formulário, assim evitando da página recarregar.
  e.preventDefault();
  ...
  if(caixaTexto.value === '') {
    ...
    inputValidacao.textContent = 'O campo de texto não pode ficar vazio.';
...
function exibeOcultaListaSuspensa() {
  ...
  if(elementoSPAN === null) {
    ...
    // Irá fazer ele voltar a opção de escolha padrão.
